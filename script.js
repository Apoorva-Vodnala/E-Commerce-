...
function UpdateCartUI() {
  ...
  CartItems.forEach((item) => {
    ...
    const QunatityConEle = Cartprod.querySelector(".quantitycon");
...
function HandleDecreQuantity(item, QuantityValEle) {
  ...
  // calling the UpdateCartUI() to update the qunatities in the ui
  UpdateCartUI();
  UpdateCartTotal();
  UpdateCartIcon();
}
...
// function to load all the items into the ui
function LoadCartUi() {
